...
def main_worker(args):
    ...
    for epoch in range(args.epochs):
        ...
        for it in range(len(train_loader_target)):
            ...
            f, f_recon, f_nv, f_nv2recon, f_mix, x_mix, mixed_target = trainer.forward(x_img, x_mesh, x_mesh_nv, pid, num_ids)
            ...
            if iterations % int(config['gen_iters']) == 0:
                trainer.module.gen_update(x_img, x_recon, x_nv, x_nv2recon, feat, feat_recon, feat_nv,
                                          feat_nv2recon, f, f_recon, f_nv, f_nv2recon, pid, index, config, iterations, centers, f_mix, x_mix, mixed_target)
